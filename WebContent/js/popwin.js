...
showWin: function(width, height, title, src) {
        ...
        var inntHtml = '';
        inntHtml += '<div id="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-index:2999;background:#000; filter:alpha(opacity=30); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity:0.3;"></div>'
        ...
        inntHtml += '<div id="maskTitle" style="height: 35px; line-height: 35px; font-family: Microsoft Yahei; font-size: 14px; color: #FFFFFF; padding:0 80px 0 10px; background-color:#006699; border-bottom: 1px solid #006699;font-weight: bolder; position: relative;">'
        inntHtml += '' + title + ''

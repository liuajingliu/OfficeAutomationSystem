...
@WebServlet("/QueryCargoServlet")
public class QueryCargoServlet extends HttpServlet {
...
//		创建业务对象
		...
		try {
			Pager pager = new Pager(service.getCargoCount(),pageNum,pageSize);
			ArrayList<Cargo> list = service.queryAllCargo(pager);

...
//		获得请求参数
		...
		int emp_id = Integer.valueOf(request.getParameter("empId"));
...
//		封装数据
		Employee emp = new Employee(emp_id, name, phone, birthday, email, qq, pwd, new Department(dept_id), new Job(job_id));
